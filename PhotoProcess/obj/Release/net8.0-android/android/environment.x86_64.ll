...
@dso_cache = dso_local local_unnamed_addr global [538 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 415908323641311948, ; hash 0x5c59a6ab1c4c2cc, from name: libaot-PhotoProcess
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PhotoProcess.dll.so
		ptr null; void* handle (0x0)
	}, ; 12
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.87_name, ; name: libaot-mscorlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 15
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1477302184735108299, ; hash 0x14806e828b0b6ccb, from name: aot-PhotoProcess.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PhotoProcess.dll.so
		ptr null; void* handle (0x0)
	}, ; 35
	...
	%struct.DSOCacheEntry {
		i64 5172333367835884917, ; hash 0x47c7d1cb39c1fd75, from name: PhotoProcess
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PhotoProcess.dll.so
		ptr null; void* handle (0x0)
	}, ; 136
	...
	%struct.DSOCacheEntry {
		i64 7170452878265391352, ; hash 0x638290e6efaf98f8, from name: aot-Ionic.Zlib.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Ionic.Zlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 179
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 9247277363155960165, ; hash 0x8054edc4826c0165, from name: PhotoProcess.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PhotoProcess.dll.so
		ptr null; void* handle (0x0)
	}, ; 261
	...
	%struct.DSOCacheEntry {
		i64 12878641644105222640, ; hash 0xb2ba20576271c9f0, from name: aot-Ionic.Zlib
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Ionic.Zlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 366
	...
	%struct.DSOCacheEntry {
		i64 13650126985300661973, ; hash 0xbd6efe2bf1d1d6d5, from name: Ionic.Zlib.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Ionic.Zlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 391
	...
	%struct.DSOCacheEntry {
		i64 14572583467442121624, ; hash 0xca3c37746c9e2b98, from name: libaot-Ionic.Zlib.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Ionic.Zlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 425
	...
	%struct.DSOCacheEntry {
		i64 15262166823181780544, ; hash 0xd3ce1bdcfe808640, from name: Ionic.Zlib
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Ionic.Zlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 443
	...
	%struct.DSOCacheEntry {
		i64 16007109454434943460, ; hash 0xde24ad3d506441e4, from name: aot-PhotoProcess
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PhotoProcess.dll.so
		ptr null; void* handle (0x0)
	}, ; 468
	%struct.DSOCacheEntry {
		i64 16018954308451743768, ; hash 0xde4ec2124c7ab818, from name: libaot-PhotoProcess.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PhotoProcess.dll.so
		ptr null; void* handle (0x0)
	}, ; 469
	...
	%struct.DSOCacheEntry {
		i64 16599915130843420684, ; hash 0xe65ebedc838dd80c, from name: libaot-Ionic.Zlib
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Ionic.Zlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 485
...
@.env.3 = private unnamed_addr constant [37 x i8] c"f3d47984-5660-4f3d-af92-5e163ebf4533\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [29 x i8] c"com.companyname.photoprocess\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [27 x i8] c"libaot-PhotoProcess.dll.so\00", align 16
@.DSOCacheEntry.9_name = private unnamed_addr constant [25 x i8] c"libaot-Ionic.Zlib.dll.so\00", align 16
...
@.DSOCacheEntry.87_name = private unnamed_addr constant [23 x i8] c"libaot-mscorlib.dll.so\00", align 16
