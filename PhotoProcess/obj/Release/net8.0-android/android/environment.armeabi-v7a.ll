...
@dso_cache = dso_local local_unnamed_addr global [538 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 521463852, ; hash 0x1f14e82c, from name: Ionic.Zlib
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 938511879, ; hash 0x37f08e07, from name: libaot-PhotoProcess
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 958884889, ; hash 0x39276c19, from name: PhotoProcess
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PhotoProcess.dll.so
		ptr null; void* handle (0x0)
	}, ; 113
	...
	%struct.DSOCacheEntry {
		i64 1089184730, ; hash 0x40eba3da, from name: libaot-PhotoProcess.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PhotoProcess.dll.so
		ptr null; void* handle (0x0)
	}, ; 132
	...
	%struct.DSOCacheEntry {
		i64 1722860931, ; hash 0x66b0c583, from name: aot-PhotoProcess.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PhotoProcess.dll.so
		ptr null; void* handle (0x0)
	}, ; 197
	...
	%struct.DSOCacheEntry {
		i64 2054845869, ; hash 0x7a7a75ad, from name: Ionic.Zlib.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Ionic.Zlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 243
	...
	%struct.DSOCacheEntry {
		i64 2386952305, ; hash 0x8e460071, from name: PhotoProcess.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PhotoProcess.dll.so
		ptr null; void* handle (0x0)
	}, ; 289
	...
	%struct.DSOCacheEntry {
		i64 2509155407, ; hash 0x958eac4f, from name: aot-Ionic.Zlib
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Ionic.Zlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 309
	...
	%struct.DSOCacheEntry {
		i64 2756374622, ; hash 0xa44af05e, from name: libaot-Ionic.Zlib
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Ionic.Zlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 345
	...
	%struct.DSOCacheEntry {
		i64 2808160660, ; hash 0xa7612194, from name: aot-Ionic.Zlib.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Ionic.Zlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 352
	...
	%struct.DSOCacheEntry {
		i64 3491244483, ; hash 0xd01829c3, from name: aot-PhotoProcess
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PhotoProcess.dll.so
		ptr null; void* handle (0x0)
	}, ; 445
	...
	%struct.DSOCacheEntry {
		i64 4107006366, ; hash 0xf4cbf19e, from name: libaot-Ionic.Zlib.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Ionic.Zlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 514
